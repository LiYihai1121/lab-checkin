...
.brand-logo.compact .logo-symbol {
  width: 34px;
  height: 34px;
  border-radius: 10px;
}
.brand-logo.compact .logo-copy strong {
  font-size: 14px;
}
</style>
